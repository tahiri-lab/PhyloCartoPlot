...
def main():
    ...
    parser.add_argument(
        "--offset", type=str, required=True, help="Path to the file for adjustments"
    )
    ...
    plt.tight_layout()
    # output_file = r"..\images\tree2map_w_caff.svg"
    # plt.savefig(output_file, format="svg")
    # output_file = r"..\images\tree2map_w_caff.png"
    # plt.savefig(output_file, format="png")
    output_dir = Path(args.gps).parent.parent / "output"  # Go up two levels from input/
    ...
    plt.savefig(str(svg_file), format="svg")
